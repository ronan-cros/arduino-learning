...
### I wrote a code that:
2. Set pin 13 as an output (pinMode(13,OUTPUT)) 
3. Turn the LED on (digitalWrite(13,HIGH))
4. Wait for n second or n x 1000 milliseconds as written in code (delay(n x 1000)) (Note: n is a variable not include in coding)
5. Turn the LED off (digitalWrite(13,LOW))
6. Wait for n second
7. Repeats forever
